...
class RAG:
    ...
    - retrieve(): search
    - build_context(): return plain text context for a question
    - enabled: flag to turn RAG on/off globally
    """
    ...
    def __init__(self):
        ...
        self.enabled = False  # RAG is off by default
    ...
    def build_context(self, question: str, top_k: int = 3) -> str:
        """Return plain text context for a question."""
